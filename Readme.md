<div align="center" style="display: flex; align-items: center; gap: 24px;">

  <img src="https://cdn-icons-png.flaticon.com/512/3075/3075977.png" alt="Restaurant Logo" width="80" height="80" style="border-radius: 18px; margin-right: 20px;"/>

  <img src="https://github.com/user-attachments/assets/4e98648a-def3-4399-9fa7-28ea29329c3e"
       alt="Restaurant Banner"
       width="64%"
       style="border-radius: 14px; box-shadow: 0 2px 16px rgba(0,0,0,0.10);"/>
</div>

# 🍽️ Restaurant Website

A visually striking, fully responsive **Restaurant Website** crafted with **HTML**, **CSS**, and **JavaScript**. This project demonstrates a modern, elegant design for a fictional restaurant—perfect for small businesses, personal portfolios, or anyone wanting to showcase web development skills with beautiful UI and smooth interactivity.

---

## 🏆 Highlights

- **Modern, polished homepage** with engaging hero section
- **Interactive menu**: Browse food & drinks by category
- **Image gallery**: Hover effects and lightbox preview (if implemented)
- **Responsive design**: Flawless on mobile, tablet, and desktop
- **Smooth navigation**: Sticky nav, animated scroll, scroll-to-top button
- **Frontend forms**: Contact & reservation (ready for backend integration)
- **Rich UI details**: Animations, transitions, and iconography
